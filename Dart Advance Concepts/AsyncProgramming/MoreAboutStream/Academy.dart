...
Stream<int> generateNumber(int max) {
  ...
  for (var i = 0; i < max; i++) {
    streamController.sink.add(
      i,
    ); // ye phla tareqa hai bagair kissi streamsink create app controller sy add kr skty hain stream mai

    // streamSink.add(
    //   i,
    // ); // ye dosra tareq hai without controller k but apko ko iss k lyee controller ko create krna pry ga
  }
